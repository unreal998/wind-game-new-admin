        ...
        if (modifier.boughtModifier.length) {
          ...
          modifier.boughtModifier.forEach((modifierData: any) => {
            ...
            const userMod = {
              ...
              ton_earned: selectedModValue?.tonValue ? Number(((selectedModValue.tonValue / 63) * (63 - modifierData.clicksRemaining)).toFixed(2)) : 0,
              coins_earned: selectedModValue?.turxValue ? Number(selectedModValue.turxValue / 63) * (63 - modifierData.clicksRemaining) : 0,
              ton_remaining: selectedModValue?.tonValue ? Number(((selectedModValue.tonValue / 63) * modifierData.clicksRemaining).toFixed(2)) : 0,
              coins_remaining: selectedModValue?.turxValue ? Number((selectedModValue.turxValue / 63) * modifierData.clicksRemaining) : 0,
