...
import { depositColumns } from "./_components/DepositColumns"
...
export default function DepositsAdminPage() {
  ...
  const transactions = getFilteredTransactions(["deposit"])
  ...
  return (
    <>
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-2xl font-semibold">Депозити</h1>
