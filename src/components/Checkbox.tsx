  ...
  return (
    <CheckboxPrimitives.Root
      ...
      className={cx(
        ...
        // checked and enabled
        "enabled:data-[state=checked]:bg-indigo-500 enabled:data-[state=checked]:ring-0 enabled:data-[state=checked]:ring-transparent",
        // indeterminate
        "enabled:data-[state=indeterminate]:bg-indigo-500 enabled:data-[state=indeterminate]:ring-0 enabled:data-[state=indeterminate]:ring-transparent",
        // focus
        focusRing,
        className,
      )}
