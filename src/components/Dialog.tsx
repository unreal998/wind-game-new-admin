  ...
  return (
    <DialogPrimitives.Overlay
      ...
      className={cx(
        ...
        "fixed inset-0 z-50 overflow-y-auto",
        // glass effect
        "bg-white/[0.02] dark:bg-gray-950/[0.02]",
        "backdrop-blur-sm",
        // gradient overlay for depth
        "after:absolute after:inset-0 after:bg-gradient-to-b",
        "after:from-white/10 after:via-white/[0.02] after:to-white/[0.075]",
        "dark:after:from-black/20 dark:after:via-gray-950/[0.02] dark:after:to-black/[0.075]",
        // additional glass effect layers
        "before:absolute before:inset-0 before:backdrop-saturate-150",
        // animation
        "data-[state=open]:animate-dialogOverlayShow",
        className,
      )}
    ...
    <DialogPortal>
      <DialogOverlay>
        <DialogPrimitives.Content
          ...
          className={cx(
            // base
            "fixed left-1/2 top-1/2 z-50 -translate-x-1/2 -translate-y-1/2 rounded-lg border",
            // variants
            size === 'default' && "w-[95vw] max-w-lg p-6",
            size === 'fullscreen' && "h-[95vh] w-[95vw] max-w-[90rem] p-0",
            // border color
