...
const selectTriggerStyles = [
  cx(
    ...
    // disabled
    "data-[disabled]:opacity-100 data-[disabled]:cursor-default data-[disabled]:bg-transparent",
    "data-[disabled]:hover:bg-transparent data-[disabled]:dark:hover:bg-transparent",
    "data-[disabled]:border-gray-300 data-[disabled]:dark:border-gray-800",
    "data-[disabled]:text-gray-900 data-[disabled]:dark:text-gray-50",
    focusInput,
    // invalid (optional)
      ...
      <SelectPrimitives.Icon asChild>
        <RiExpandUpDownLine
          className={cx(
            ...
            // disabled - змінюємо стилі іконки для disabled стану
            "group-data-[disabled]/trigger:text-gray-400 group-data-[disabled]/trigger:dark:text-gray-600",
          )}
        />
