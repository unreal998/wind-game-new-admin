...
>(({ className, hint, shortcut, children, ...props }, forwardedRef) => (
  ...
  >
    <span className="absolute left-2 flex size-4 items-center justify-center">
      <RiRadioButtonFill
        aria-hidden="true"
        className="size-full shrink-0 text-indigo-500 group-data-[state=checked]/DropdownMenuRadioItem:flex group-data-[state=unchecked]/DropdownMenuRadioItem:hidden dark:text-indigo-500"
      />
      <RiCheckboxBlankCircleLine
        aria-hidden="true"
